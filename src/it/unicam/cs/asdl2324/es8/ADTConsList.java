...
public interface ADTConsList<E> {
    ...
    default ADTConsList<E> removeAll(E element) {
        ...
        if (this.first().equals(element))	//Caso Ricorsivo
    ...
    default ADTConsList<E> append(ADTConsList<E> list) {
    	...
    	return this.rest().append(list).cons(null);	//Caso Ricorsivo
    }
    ...
    default ADTConsList<E> reverse() {
    	...
    	return this.rest().reverse().append(EMPTY_LIST.cons(this.first()));	//Caso Ricorsivo
    }
